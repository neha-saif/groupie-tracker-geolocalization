...
func MapsApiResp(city, country string) (FinalGeo, error) {
	...
	apiKey := "AIzaSyDeoZSLirOv1VBE5QBY59jZJH_ssdHaYro"

finalgeo[0].MapURL = fmt.Sprintf("https://maps.googleapis.com/maps/api/staticmap?center=%s,%s&zoom=14&size=600x400&maptype=roadmap&key=%s", city, country, apiKey)
